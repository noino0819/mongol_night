  ...
  acts: [
    {
      ...
      objects: [
        ...
        { id: "letter", nm: "품속의 급보", spr: "letter",
          need: "lit", lockedTxt: "어두워서 겉장의 글이 안 보인다. 불부터 밝혀요.",
        ...
        { id: "fire", nm: "화로", spr: "fire",
          ...
          find: { prompt: "재를 헤쳐 봐요. 표식을 새긴 돌들이 나온다.", cols: 4,
        ...
        { id: "trunk", nm: "가죽 궤", spr: "trunk",
          ...
          lock: { ans: ["7249"], digits: 4, type: "dial", prompt: "다이얼을 돌려 맞춰 봐요.",
        ...
        { id: "door", nm: "게르 문", spr: "door",
          txt: "남쪽 문. 밖에서 빗장이 질렸고, 문틈으로 창끝의 그림자가 오간다. 밤을 지키는 헵투울이다. 문지방을 밟는 건 죽음이고 — 어차피 이 문은 열리지 않는다. 다른 길을 찾아요." },
    ...
    },
    {
      ...
      objects: [
        ...
        { id: "pen", nm: "말 울타리", spr: "horse",
          ...
          torch: { prompt: "기둥을 비춰 봐요 — 새김이 차례를 말해 준다.",
  ...
  acts: [
    {
      ...
      combos: [
        { need: ["rod", "weight"], gives: "pendulum",
          assemble: { base: "rod", piece: "weight", scale: 2,
            prompt: "놋쇠 추를 끌어다 막대 끝 고리에 걸어 봐요.",
      ...
      objects: [
        ...
        { id: "letter", nm: "머리맡 편지", spr: "letter",
          need: "lit", lockedTxt: "머리맡에 접힌 종이가 있는데 어두워 글자가 안 보인다. 불부터 밝혀요.",
        ...
        { id: "clocks", nm: "조문 시계들", spr: "wallclock",
          ...
          txt: "마을에서 옮겨 온 조문 시계들. 사람들이 스승을 보내며 저마다 자기 시계를 멈춰 여기 걸어 두었다. 바늘을 하나하나 확인해 봐요 — 다들 같은 시각을 가리키고 있을 테니까요.",
          find: { prompt: "시계를 눌러 바늘을 확인해 봐요. 마을이 그를 보낸 그 시각을, 대부분의 바늘이 함께 가리키고 있어요.", cols: 3,
        ...
        { id: "marks", nm: "벽시계 속 각인", spr: "mirrorclock",
          need: "lit", lockedTxt: "시계 뚜껑을 여니 안쪽이 캄캄하다. 빛이 있어야 보이겠어요.",
          txt: "벽시계 뚜껑을 열자 무브먼트가 드러난다. 안쪽 판에 손톱으로 긁어 새긴 이름과 해가 켜켜이 쌓였다 — 이 시계를 거쳐 간 모든 손의 기록이다. 등불을 가까이 대고 훑어 봐요.",
          torch: { prompt: "안쪽 판을 훑어 새김을 찾아봐요. 가장 오래된 해에 이름을 남긴 사람이, 이 시계를 처음 만든 이예요.",
    ...
    },
    {
      ...
      objects: [
        ...
        { id: "cabinet", nm: "거울 벽장", spr: "cabinet",
          ...
          lock: { ans: ["900"], digits: 3, type: "dial", prompt: "다이얼을 돌려 맞춰 봐요.",
        ...
        { id: "bigdial", nm: "대시계 조정판", spr: "bigdial",
          ...
          lock: { ans: ["1200"], digits: 4, type: "dial", prompt: "다이얼을 돌려 자정을 맞춰 봐요.",
            hints: ["편지의 부탁 — 자정을 가리키게 하라. 자정은 몇 시일까요?", "자정은 열두 시 정각. 종이 열두 번 우는 그 시각이에요.", "1200."],
            open: "바늘이 열두 시 정각에 겹치는 순간 — 뎅. 뎅. 대종이 열두 번을 다 울리고, 멈췄던 밤이 다시 흐르기 시작한다. 동쪽 하늘이 밝아 온다. 스승의 시계가, 스스로 걷는다. 탈출이에요." } }
      ]
    }
  ]
});
ER_SCENARIOS.push({
  ...
  outro: "여명이 저택을 삼킨다. 등 뒤에서 느긋한 박수 — '예의는 아는 손님이었어. 다음 만찬도 기대하지.' 다음엔 낮 모임인지 꼭 확인하고 받아요.",
  acts: [
    {
      id: "dinner",
      name: "1막 · 붉은 만찬",
      intro: "초대장 한 장에 홀려 저택 만찬에 왔다. 수프가 나오기도 전에 V 백작은 '볼일이 있다'며 사라졌고, 등 뒤에서 문이 잠겼다. 어디서 많이 본 전개인데.\n\n다행히 이 백작, 낡은 민속 규칙에 강박적으로 묶여 있다더라. 규칙을 거꾸로 쓰면 나갈 수 있을지도. 뭐든 눌러서 조사해 봐요.",
      time: 720,
      hearts: 5,
      ...
      objects: [
        ...
        { id: "mirror", nm: "낡은 거울", spr: "mirror",
          need: "dark", lockedTxt: "촛불이 환해서 거울엔 겁먹은 네 얼굴만 잘 보인다. 볼 만하긴 한데 단서는 아니에요.",
        ...
        { id: "clock", nm: "벽시계", spr: "wallclock",
          ...
          lock: { ans: ["0512"], digits: 4, type: "dial", prompt: "다이얼을 돌려 맞춰 봐요.",
        ...
        { id: "seeds", nm: "쏟아진 씨앗", spr: "feasttable",
          txt: "식탁 밑에 씨앗이 왕창 쏟아져 있다. 붉은 겨자씨와 흰 쌀알. 민속에 따르면 뱀파이어는 흘린 씨앗을 다 세기 전엔 움직이지 못한다더라 — 세서미 스트리트 그 백작이 괜히 숫자를 세는 게 아니지. 백작이 돌아오기 전에, 우리가 대신 세 줘요.",
          find: { prompt: "씨앗을 눌러 확인하며 세어 봐요. 붉은 겨자씨의 수, 그다음 흰 쌀알의 수 — 그 순서예요.", cols: 4,
        ...
        { id: "winerack", nm: "은식기 진열장", spr: "winerack",
          ...
          lock: { ans: ["83"], digits: 2, type: "dial", prompt: "다이얼을 돌려 맞춰 봐요.",
            hints: ["백작이 흘리고 간 씨앗을 누가 대신 세어 줘야 한댔죠. 두 종류, 순서도 있어요.", "붉은 겨자씨 여덟, 흰 쌀알 셋. 붉은 것 먼저.", "83."],
            open: "진열장이 열린다. 와인은 전부 '1476년산'인데 성분표시가 없다. 안 마시는 게 좋겠어요. 안쪽에 은포크가 곱게 놓여 있다.",
            give: "fork" } },
        { id: "portrait", nm: "백작의 초상화", spr: "portrait", final: true,
          txt: "젊은 시절의 V 초상화. 눈이 자꾸 이쪽을 따라온다. 액자 옆 벽에 십자 모양 홈이 파여 있어 — 열쇠 구멍치고는 좀 성스러운데. 꽂을 만한 게 있으면 좋겠어요.",
          lock: { item: "cross",
            open: "은십자가를 홈에 꽂자 초상화가 빙글 돌며 비밀 통로가 열린다. 벽 너머 어둠 속에서 V의 목소리 — '…예절은 아는 손님이군.' 칭찬이야, 뭐야. 일단 들어가요." } }
      ]
    },
    {
      id: "dawn",
      ...
      objects: [
        ...
        { id: "font", nm: "성수반", spr: "font",
          give: "holy",
          txt: "예배실 구석의 돌 수반. 집사가 채워 둔 성수가 찰랑거린다. 빈 병에 담았다. 마시진 마요 — 그냥 미지근한 물맛이라는 소문이 있어." },
        ...
        { id: "clocks", nm: "네 개의 괘종시계", spr: "fourclocks",
          ...
          txt: "동쪽 홀 벽에 괘종시계 네 대. 석관 새김이 말했지 — 산 자의 시계는 거짓, 죽은 시계만이 새벽을 안다. 어느 것이 '죽어' 멎어 있는지 하나하나 확인해 봐요.",
          find: { prompt: "시계를 눌러 확인해요. 셋은 멀쩡히 재깍거리며 제각각 거짓을 말하고, 딱 하나만 먼지를 쓴 채 멎어 있어요. 멎은 시계의 시각이 정직한 시각이에요.",
  ...
  acts: [
    {
      ...
      objects: [
        { id: "stat", nm: "상태창", spr: "statwin",
          txt: "[ 상태창 ]\n이름: 베르크\n힘  4 — 주먹은 폼이야\n지능 7 — 머리는 장식이 아니다\n운  2 — 하늘이 버렸어\n\n스탯 한번 짜다. 3화에서 죽는 엑스트라 스펙 맞네. 상태창은 언제든 다시 열어 볼 수 있어요." },
        ...
        { id: "tapestry", nm: "벽걸이 태피스트리", spr: "tapestry",
          need: "lit", lockedTxt: "벽에 커다란 천이 걸려 있는데 너무 어두워 무늬가 안 보여. 빛부터 어떻게 해 봐요.",
        ...
        { id: "safe", nm: "벽금고", spr: "safebox",
          ...
          lock: { ans: ["742"], digits: 3, type: "dial", prompt: "다이얼을 남작의 버릇대로 돌려 봐요.",
    ...
    },
    {
      ...
      objects: [
        { id: "glitch", nm: "버그난 시스템 로그", spr: "glitchwin",
          txt: "허공의 시스템창이 지지직거린다. 스킬 이름이 깨져 흩어졌는데, 그 사이로 몇 글자만 붉게 살아 남아 깜빡인다. 노이즈는 버리고, 붉은 글자만 순서대로 이어 읽어 봐요.",
          ctext: { prompt: "붉은 글자만 이어 읽으면 깨진 스킬의 이름이에요.",
            segs: [ { t: "[시스템] z#x" }, { t: "해", c: "fire" }, { t: "q▚w0x1 §¶", br: true },
                    { t: "ther3 ##" }, { t: "방", c: "fire" }, { t: " err0r ▚▚ nul" } ] } },
        { id: "trio", nm: "연회장의 세 사람", spr: "trio",
          txt: "연회장에 셋이 모여 있다. 초상을 하나씩 눌러 말을 붙여 봐요 — 사람은 곱씹을수록 다른 걸 흘리는 법이니까.",
          speech: [
        ...
        { id: "diary", nm: "전대 빙의자의 일지", spr: "book",
          need: "vault", lockedTxt: "지하 서고 안쪽에 있어. 입구의 결계부터 어떻게 해야 해요.",
        ...
        { id: "butler", nm: "집사 노얀", spr: "butler",
          txt: "노얀이 온화하게 웃으며 다가온다. 어디서 읽은 장면인데. 이 자를 흔들려면 증거가 될 물건을 들이밀어야 해요.",
          speech: [
        ...
        { id: "gate", nm: "완결의 문", spr: "endgate", final: true,
          need: "exposed", lockedTxt: "문이 미동도 없다. 이야기는 범인을 지목해야 끝나는 법이지. 흑막의 정체부터 밝혀내 봐요.",
