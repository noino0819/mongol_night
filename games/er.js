...
/* ---- er 전용 스프라이트 (59종; 32×32 조합조각 4종 포함) — 병렬 세션 충돌 방지를 위해 index.html SPR이 아닌 여기서 등록 ---- */
/*SPR_BEGIN*/
snAddSprites({
stone:[
"................",
...
"................",
"................"],
/* ---- 32×32 클로즈업 조합 조각(시계탑 겹쳐 맞추기) — 도트 가이드 해상도 티어 2단 ---- */
cog:[
"...............22...............",
"..............2222..............",
".............222222.............",
...
".....222......2222......222.....",
"....22222....222222....22222....",
"....22222.222222222222.22222....",
"....222222222222222222222222....",
".....2222222222222222222222.....",
".......222222222222222222.......",
"......22222222222222222222......",
"......22222222777722222222......",
"......22222277222277222222......",
"..22.2222222722222272222222.77..",
".2222222222722....2272222227777.",
"22222222222722....22722222777777",
"22222222222722....22722227777777",
".2222222222722....2272227777777.",
"..22.2222222722222272227777.77..",
"......22222277222277227777......",
"......22222222777722277777......",
"......22222222222222777777......",
".......222222222222777777.......",
".....2222222222222777777777.....",
"....222222222222277777777777....",
"....22222.222222777777.77777....",
"....22222....227777....77777....",
".....222......7777......777.....",
".............777777.............",
".............777777.............",
...
snAddScreen("er", `
    ...
    <div id="er-setup">
      <p class="hint">오브젝트를 눌러 <b>조사</b>하고, 단서로 <b>암호를 풀고</b>, 얻은 것들을 <b>조합해</b> 탈출해 보세요. 다 같이 화면 보며 머리를 모으는 협동 방탈출 — 시나리오당 2막.</p>
...
.er-brief p{margin:8px 0 0;line-height:1.7;white-space:pre-line}
  ...
  acts: [
    {
      id: "guestger",
      name: "제1막 · 손님의 게르",
      intro: "1206년 봄, 오논 강가의 대영지. 내일 아침 쿠릴타이에서 테무진이 칸으로 추대된다.\n\n서쪽 국경의 급보를 품고 밤새 달려온 너는, 나이만의 첩자로 몰려 손님 게르에 갇혔다. 품속의 봉인된 급보만은 지켜냈다.\n\n새벽 경비 교대 전에 나가야 한다 — 무엇이든 눌러 조사하라.",
      ...
      objects: [
        ...
        { id: "letter", nm: "품속의 급보", spr: "letter",
          need: "lit", lockedTxt: "어두워서 겉장의 글이 안 보인다. 불부터 밝혀라.",
        ...
        { id: "chest", nm: "궤짝", spr: "chest",
          ...
          lock: { ans: ["쿠릴타이"],
            hints: ["급보를 등잔불에 다시 비춰 봐요. 호박빛 글자만 좇으면 말이 엉켜요 — 푸른 글자는 뭐라 말하고 있을까요.", "푸른 글자는 '거꾸로'. 호박빛 글자를 거꾸로 읽으면 사내들이 내일 입에 올릴 그 말이 돼요.", "쿠릴타이."],
        ...
        { id: "fire", nm: "화로", spr: "fire",
          ...
          find: { prompt: "재를 헤쳐 보라. 표식을 새긴 돌이 나온다.", cols: 4,
        ...
        { id: "trunk", nm: "가죽 궤", spr: "trunk",
          ...
          lock: { ans: ["7249"], digits: 4, type: "dial", prompt: "다이얼을 돌려 맞춰라.",
            hints: ["뚜껑에 샤가이가 왜 매여 있을까요. 재 속에서 찾은 것들과 짝이 맞을지도 몰라요.", "말·낙타·양·염소의 차례로, 재 속 돌의 숫자를. 늑대와 매는 가축이 아니에요.", "7249."],
            open: "궤가 열렸다. 잘 꼰 말총 밧줄이 사려 있다.",
            give: "rope" } },
        { id: "door", nm: "게르 문", spr: "door",
          txt: "남쪽 문. 밖에서 빗장이 질렸고, 문틈으로 창끝의 그림자가 오간다. 밤을 지키는 헵투울이다. 문지방을 밟는 건 죽음이고 — 어차피 이 문은 열리지 않는다. 다른 길을 찾아라." },
    ...
    },
    {
      id: "camp",
      name: "제2막 · 새벽의 대영지",
      intro: "칼로 천창의 가죽끈을 끊고, 밧줄을 타고 게르 뒤편에 내려섰다. 동트기 전의 푸른 어둠.\n\n말을 찾아, 헵투울의 눈을 피해, 대게르에 급보를 전해야 한다.",
      time: 720,   /* 하드코어 12분 */
      hearts: 5,
      ...
      objects: [
        { id: "post", nm: "초소 명부", spr: "journal",
          txt: "빈 초소에 명부가 펼쳐져 있다. 한 장씩 넘겨 보라.",
          pages: { sheets: [
            "낮 당번. 낮을 지키는 토르구드, 일흔.",
            "밤 당번 — 이 면은 누가 찢어 갔다. 찢긴 자리 여백에 급히 갈긴 글씨: \"밤은 낮보다 열이 많다.\"" ] } },
        { id: "gearchest", nm: "마구 궤", spr: "stable",
          txt: "초소 옆 마구 궤. 두 자리 다이얼 — 헵투울의 창 문양이 찍혀 있다.",
          lock: { ans: ["80"], digits: 2, type: "dial", prompt: "다이얼을 돌려 맞춰라.",
            hints: ["명부 — 밤 당번은 몇이었을까요.", "낮이 일흔. 밤은 그보다 열이 많아요.", "80."],
        ...
        { id: "pen", nm: "말 울타리", spr: "horse",
          ...
          torch: { prompt: "기둥을 비춰 보라 — 새김 셋이 드러난다.",
            marks: [ { s: "sulde", x: 20, y: 38 }, { s: "bigdipper", x: 50, y: 62 }, { s: "ovoo", x: 80, y: 40 } ] },
          lock: { ans: ["973"], digits: 3,
            hints: ["빗장 옆 기둥을 손전등으로 비춰 봤어요? 새김 셋이 순서를 말해 줘요.", "술데를 세고, 별을 세고, 발자국이 오보를 감은 바퀴를 세어 봐요.", "973."],
  ...
  acts: [
    {
      id: "downstairs",
      name: "제1막 · 멈춘 시계들",
      intro: "시계공 오르트가 어젯밤 눈을 감았다. 마을 풍습대로, 사람이 떠나면 그 시계를 그 시각에 멈춘다. 오늘 아침 마을의 시계가 모두 멎었다.\n\n허나 스승의 유언은 하나였다 — '내 탑의 대시계만은 멈추지 마라. 자정을 완성하는 것이 네 졸업 시험이다.'\n\n문은 잠겼고 대시계도 멎었다. 스승의 흔적을 따라 위층 기계실로 올라가 보라. 무엇이든 먼저 눌러 조사해 보라.",
      time: 900,
      hearts: 5,
      items: { rod: "진자 막대", weight: "놋쇠 추", pendulum: "완성된 진자" },
      combos: [
        { need: ["rod", "weight"], gives: "pendulum",
          assemble: { base: "rod", piece: "weight", scale: 2,
            prompt: "놋쇠 추를 끌어다 막대 끝 고리에 걸어 보라.",
            text: "막대 끝 고리에 추를 걸자 묵직하게 균형이 잡혔다. 시계의 심장이 될 진자다." },
          text: "막대 끝 고리에 추를 걸자 묵직하게 균형이 잡혔다. 시계의 심장이 될 진자다." }
      ],
      objects: [
        ...
        { id: "letter", nm: "머리맡 편지", spr: "letter",
          need: "lit", lockedTxt: "머리맡에 접힌 종이가 있는데 어두워 글자가 안 보인다. 불부터 밝혀라.",
        ...
        { id: "clocks", nm: "조문 시계들", spr: "wallclock",
          ...
          txt: "마을에서 옮겨 온 조문 시계들. 사람들이 스승을 보내며 저마다 자기 시계를 멈춰 여기 걸어 두었다. 바늘을 하나하나 확인해 보라 — 다들 같은 시각을 가리키고 있을 테니.",
          find: { prompt: "시계를 눌러 바늘을 확인해 보라.", cols: 3,
        ...
        { id: "chest", nm: "종 궤짝", spr: "chest",
          ...
          lock: { ans: ["1147"], digits: 4,
            hints: ["조문 시계들이 함께 가리키던 그 시각이에요.", "대부분의 바늘이 열한 시 사십칠 분에 멎어 있었어요.", "1147."],
            open: "궤가 열리고 묵직한 놋쇠 추가 나왔다. 진자에 달 무게다.",
            give: "weight" } },
        { id: "marks", nm: "벽시계 속 각인", spr: "mirrorclock",
          need: "lit", lockedTxt: "시계 뚜껑을 여니 안쪽이 캄캄하다. 빛이 있어야 보이겠다.",
          txt: "벽시계 뚜껑을 열자 무브먼트가 드러난다. 안쪽 판에 손톱으로 긁어 새긴 이름과 해가 켜켜이 쌓였다 — 이 시계를 거쳐 간 모든 손의 기록이다. 등불을 가까이 대고 훑어 보라.",
          torch: { prompt: "안쪽 판을 훑어, 손톱으로 새긴 이름과 해를 찾아보라.",
        ...
        { id: "drawer", nm: "스승의 서랍", spr: "drawer",
          ...
          lock: { ans: ["오르트"], digits: 3,
            hints: ["이 서랍은 만든 이의 이름으로 열려요. 그 이름, 시계 속을 뒤졌다면 봤을 텐데요.", "1871년에 새겨진 이름. 스승 본인이에요.", "'오르트'."],
    ...
    },
    {
      id: "machineroom",
      name: "제2막 · 심장을 되감다",
      intro: "계단 끝, 대시계의 기계실이다. 거대한 태엽과 톱니가 숨을 죽이고 있다.\n\n태엽을 감고, 자정을 가리키게 바늘을 맞춰야 이 밤이 끝난다. 스승이 남긴 마지막 시험이다.",
      time: 900,
      hearts: 5,
      items: { crank: "태엽 손잡이", cog: "톱니바퀴", winder: "태엽 감개" },
      combos: [
        { need: ["crank", "cog"], gives: "winder",
          assemble: { base: "crank", piece: "cog", scale: 2,
            prompt: "톱니를 끌어다 손잡이 축에 끼워 보라.",
            text: "손잡이 축에 톱니를 끼우자 딱 맞물렸다. 태엽을 감을 수 있는 감개가 완성됐다." },
          text: "손잡이 축에 톱니를 끼우자 딱 맞물렸다. 태엽을 감을 수 있는 감개가 완성됐다." }
      ],
      objects: [
        ...
        { id: "cabinet", nm: "거울 벽장", spr: "cabinet",
          ...
          lock: { ans: ["900"], digits: 3, type: "dial", prompt: "다이얼을 돌려 맞춰 보라.",
            hints: ["거울 글씨 벽시계를 손거울에 비추면 바늘이 어디를 가리킬까요.", "3시 자리를 거울에 비추면 9시. 9시 정각이에요.", "900."],
        ...
        { id: "bellchest", nm: "카운트휠 궤", spr: "toolbox",
          ...
          lock: { ans: ["78"], digits: 2,
            hints: ["'하루의 종을 다 더하라'잖아요. 시계가 시각마다 몇 번씩 우는지 떠올려 봐요.", "자정(12)까지 1 더하기 2 더하기 … 더하기 12를 더해 봐요.", "78."],
        ...
        { id: "bigdial", nm: "대시계 조정판", spr: "bigdial",
          ...
          lock: { ans: ["1200"], digits: 4, type: "dial", prompt: "다이얼을 돌려 자정을 맞춰 보라.",
            hints: ["편지의 부탁 — 자정을 가리키게 하라. 자정은 몇 시일까요?", "자정은 열두 시 정각. 종이 열두 번 우는 그 시각이에요.", "1200."],
            open: "바늘이 열두 시 정각에 겹치는 순간 — 뎅. 뎅. 대종이 열두 번을 다 울리고, 멈췄던 밤이 다시 흐르기 시작한다. 동쪽 하늘이 밝아 온다. 스승의 시계가, 스스로 걷는다. 탈출이다." } }
      ]
    }
  ]
});
  ...
  acts: [
    {
      id: "dinner",
      name: "1막 · 붉은 만찬",
      intro: "초대장 한 장에 홀려 저택 만찬에 왔다. 수프가 나오기도 전에 V 백작은 '볼일이 있다'며 사라졌고, 등 뒤에서 문이 잠겼다. 어디서 많이 본 전개인데.\n\n다행히 이 백작, 낡은 민속 규칙에 강박적으로 묶여 있다더라. 규칙을 거꾸로 쓰면 나갈 수 있을지도. 뭐든 눌러서 조사해 보자.",
      time: 720,
      hearts: 5,
      ...
      combos: [
        { need: ["fork", "knife"], gives: "cross",
          assemble: { base: "fork", piece: "knife", rotate: 90,
            prompt: "은나이프를 끌어다 포크 위에 십자로 겹쳐 보자.",
      ...
      objects: [
        { id: "invite", nm: "초대장", spr: "letter",
          txt: "V가 남긴 초대장이다. 한 장씩 넘겨 읽어 보자.",
          pages: { sheets: [
            "친애하는 손님께. 잠시 볼일이 있어 자리를 비웁니다. 부디 편히 계시길. — V",
            "한 가지. 절대 촛불을 끄지 말 것. 절대로.",
            "그리고 포크와 나이프는 반드시 겹쳐 두시길. — V\n\n…이렇게까지 강조하면 오히려 더 하고 싶어진다. (참고로 이 저택은 예산 문제로 16×16픽셀로 지어졌지만 분위기는 만점이다.)" ] } },
        ...
        { id: "mirror", nm: "낡은 거울", spr: "mirror",
          need: "dark", lockedTxt: "촛불이 환해서 거울엔 겁먹은 네 얼굴만 잘 보인다. 볼 만하긴 한데 단서는 아니다.",
        ...
        { id: "clock", nm: "벽시계", spr: "wallclock",
          ...
          lock: { ans: ["0512"], digits: 4, type: "dial", prompt: "다이얼을 돌려 맞춰 보자.",
            hints: ["어둠 속 거울에서 시계를 봤어요. 새김이 시간을 어떻게 읽으라고 했죠?", "거울 속 시계는 21시 50분(2150), 거꾸로 흐르고 있었어요. 끝에서부터 읽으면?", "2150을 뒤집으면 0512. 새벽 5시 12분이에요."],
        ...
        { id: "seeds", nm: "쏟아진 씨앗", spr: "feasttable",
          ...
          find: { prompt: "씨앗을 눌러 종류별로 세어 보자 — 붉은 것부터.", cols: 4,
        ...
        { id: "winerack", nm: "은식기 진열장", spr: "winerack",
          ...
          lock: { ans: ["83"], digits: 2, type: "dial", prompt: "다이얼을 돌려 맞춰 보자.",
            hints: ["백작이 흘리고 간 씨앗을 누가 대신 세어 줘야 한댔죠. 두 종류, 순서도 있어요.", "붉은 겨자씨 여덟, 흰 쌀알 셋. 붉은 것 먼저.", "83."],
            open: "진열장이 열린다. 와인은 전부 '1476년산'인데 성분표시가 없다. 안 마시는 게 좋겠다. 안쪽에 은포크가 곱게 놓여 있다.",
            give: "fork" } },
        { id: "portrait", nm: "백작의 초상화", spr: "portrait", final: true,
          txt: "젊은 시절의 V 초상화. 눈이 자꾸 이쪽을 따라온다. 액자 옆 벽에 십자 모양 홈이 파여 있어 — 열쇠 구멍치고는 좀 성스러운데. 꽂을 만한 게 있으면 좋겠다.",
          lock: { item: "cross",
    ...
    },
    {
      id: "dawn",
      name: "2막 · 새벽이 오기 전에",
      intro: "초상화 뒤 통로는 지하 예배당으로 이어졌다. 공기가 차고 바닥엔 검은 안개가 낮게 흐른다.\n\n창 틈 하늘이 아주 조금 옅어졌다 — 새벽이 가깝다. 해가 뜨기 전에 동쪽 홀을 찾아 나가야 한다. 백작이 '볼일'을 마치고 돌아오기 전에.",
      time: 900,
      hearts: 5,
      ...
      objects: [
        { id: "diary", nm: "집사의 일지", spr: "diary",
          txt: "집사의 일지다. 날짜별로 적혀 있다. 한 장씩 넘겨 보자.",
          pages: { sheets: [
        ...
        { id: "font", nm: "성수반", spr: "font",
          give: "holy",
          txt: "예배실 구석의 돌 수반. 집사가 채워 둔 성수가 찰랑거린다. 빈 병에 담았다. 마시진 말자 — 그냥 미지근한 물맛이라는 소문이 있다." },
        ...
        { id: "coffin", nm: "백작의 석관", spr: "coffin",
          need: "mistgone", lockedTxt: "안개 너머로 검은 석관 윤곽만 보인다. 지금 들어가면 안개한테 잡아먹힐 것 같다.",
        ...
        { id: "organ", nm: "파이프오르간", spr: "organ",
          ...
          lock: { ans: ["1476"], digits: 4,
            hints: ["명판이 말하잖아요 — 가문이 시작된 해. 가문의 역사가 통째로 걸린 물건이 있었어요.", "가계도 맨 위, 시조 V가 태어난 해. 유일하게 죽은 해가 없는 그 사람. 와인 라벨도 같은 해였어요.", "1476. 건반 1-4-7-6을 차례로 짚어요."],
        ...
        { id: "clocks", nm: "네 개의 괘종시계", spr: "fourclocks",
          ...
          txt: "동쪽 홀 벽에 괘종시계 네 대. 석관 새김이 말했지 — 산 자의 시계는 거짓, 죽은 시계만이 새벽을 안다. 어느 것이 '죽어' 멎어 있는지 하나하나 확인해 보자.",
          find: { prompt: "시계를 눌러 시각을 확인해 보자. 셋은 재깍거리고, 딱 하나만 먼지를 쓴 채 멎어 있다.",
            cells: [ { s: "wallclock", c: "7:15" }, { s: "wallclock", c: "11:40" }, { s: "wallclock", c: "3:33" }, { s: "deadclock", c: "4:26" } ] } },
        { id: "safe", nm: "서재 금고", spr: "safe",
          need: "easthall", lockedTxt: "서재는 동쪽 홀 안쪽이다. 아직 갈 길이 없다.",
          txt: "동쪽 홀 서재의 검은 금고. 네 자리 다이얼 위에 새김 — '정직한 시각만이 나를 연다.'",
          lock: { ans: ["0426"], digits: 4,
            hints: ["석관 뚜껑 안쪽 새김을 떠올려 봐요. 어떤 시계를 믿어야 하죠?", "괘종시계 넷 중 먼지 쓰고 멎은 하나 — 그게 정직한 시각이에요.", "멎은 시계는 4시 26분. 0426이에요."],
            open: "철컥. 금고 안엔 보석도 유언장도 아니고 — 황금 크랭크 손잡이 하나. 커튼 감아올리는 그거. 백작이 목숨처럼 숨겨 둔 이유가 있겠지. …그때, 위층에서 현관문 열리는 소리. 돌아왔다. 서둘러요.",
            give: "crank" } },
  ...
  acts: [
    {
      ...
      intro: "밤새 웹소설 『철혈의 성좌』를 읽다 잠들었는데, 눈을 떠 보니 중세 성의 침실이다. 허공에 뜬 픽셀 상태창, 몸에 안 맞는 실크 잠옷.\n\n나, 3화 끝에서 죽는 엑스트라 '망나니 남작 베르크'에 빙의했다. 원작 178쪽 — '조연 베르크는 그 방에서 끝내 나오지 못했다.' 원작대로 굴면 나도 그 꼴이란 소리다.\n\n다행인 건 딱 하나, 난 이 소설을 마지막 연재분까지 다 읽었다는 것. 원작 지식 풀가동으로, 정해진 죽음을 비틀어 나가 보자.",
      time: 720,
      hearts: 5,
      ...
      combos: [
        { need: ["seala", "sealb"], gives: "seal",
          assemble: { base: "sealb", piece: "seala",
            prompt: "인장 반쪽(위)을 끌어다 아래 반쪽에 딱 맞춰 겹쳐 보자.",
            text: "반쪽 두 개를 맞대자 딱 — 남작가의 사자 인장이 완성됐다. 이 시스템, 일 좀 하네." },
          text: "반쪽 두 개를 맞대자 딱 — 남작가의 사자 인장이 완성됐다. 이 시스템, 일 좀 하네." }
      ],
      objects: [
        { id: "stat", nm: "상태창", spr: "statwin",
          txt: "[ 상태창 ]\n이름: 베르크\n힘  4 — 주먹은 폼이야\n지능 7 — 머리는 장식이 아니다\n운  2 — 하늘이 버렸어\n\n스탯 한번 짜다. 3화에서 죽는 엑스트라 스펙 맞네. 상태창은 언제든 다시 열어 볼 수 있다." },
        ...
        { id: "tapestry", nm: "벽걸이 태피스트리", spr: "tapestry",
          need: "lit", lockedTxt: "벽에 커다란 천이 걸려 있는데 너무 어두워 무늬가 안 보인다. 빛부터 어떻게 해 보자.",
          txt: "햇빛에 무늬가 살아난다. 원작 3화에서 딱 한 줄로 지나간 그 태피스트리다 — '문장(紋章)의 벽걸이. 앞선 것, 따르는 것, 그리고 남는 것.' 초원빛 용이 앞서고, 은실 기사가 뒤를 따르고, 금실 성이 끝에 남는다. 몇씩 수놓였는지는 직접 세어야 한다.",
          find: { cols: 3, prompt: "수놓인 문장을 하나씩 눌러 헤아려 보라.",
            cells: [ { c: "용" }, { c: "기사" }, { c: "성" }, { c: "기사" }, { c: "용" }, { c: "기사" }, { c: "기사" }, { c: "용" }, { c: "기사" } ] } },
        { id: "safe", nm: "벽금고", spr: "safebox",
          txt: "벽에 박힌 철제 금고. 세 자리 다이얼이다. 소설에 남작이 금고 여는 버릇이 적혀 있었지.",
          lock: { ans: ["742"], digits: 3, type: "dial", prompt: "다이얼을 남작의 버릇대로 돌려 보자.",
            hints: ["원작 3화 — 머리 먼저, 다음은 주먹, 마지막은 하늘. 순서를 어기면 안 열린다고 했어요.", "상태창을 다시 열어 봐요. 머리=지능, 주먹=힘, 하늘=운. 그 숫자를 버릇 순서대로.", "지능 7, 힘 4, 운 2. 742."],
        ...
        { id: "drawer", nm: "3단 서랍장", spr: "drawer",
          ...
          lock: { ans: ["351"], digits: 3,
            hints: ["서랍에 새겨진 용·기사·성. 벽의 태피스트리에도 똑같은 게 수놓여 있었어요.", "원작의 그 구절 — 앞선 것, 따르는 것, 남는 것. 용 몇, 기사 몇, 성 몇인지 그 순서대로.", "용 3, 기사 5, 성 1. 351."],
    ...
    },
    {
      id: "a2",
      name: "2장 · 상태창 없는 자",
      intro: "침실을 나서자 대연회장. 그런데 상황이 이상하다. 시스템창이 지지직 깨지고, 연회장 끝엔 원작에 없던 '거대한 책 모양의 문'이 서 있다.\n\n문에 적힌 조건은 단 하나 — '흑막의 이름을 부르면 이야기는 완결된다.'\n\n문제가 있어. 『철혈의 성좌』는 12장에서 흑막의 정체를 밝히기 직전, 작가가 연중해 버린 소설이다. 결말을 안다며? 연중작이라 결말이 없는데. 원작 지식이 여기서 뚝 끊긴다 — 이제부턴 내가 추리해서 쓴다.",
      time: 900,
      hearts: 5,
      ...
      objects: [
        { id: "glitch", nm: "버그난 시스템 로그", spr: "glitchwin",
          txt: "허공의 시스템창이 지지직거린다. 스킬 이름이 깨져 흩어졌는데, 그 사이로 몇 글자만 붉게 살아 남아 깜빡인다.",
          ctext: { prompt: "깜빡이는 글자를 눈여겨보라.",
        ...
        { id: "shelf", nm: "주문서 서가", spr: "shelf",
          ...
          lock: { ans: ["해방"], digits: 2,
            hints: ["버그난 로그, 노이즈 사이에 유독 살아남은 게 있었어요.", "노이즈 사이 붉은 글자는 '해'와 '방'. 두 글자예요.", "주문의 이름은 '해방'."],
        ...
        { id: "diary", nm: "전대 빙의자의 일지", spr: "book",
          need: "vault", lockedTxt: "지하 서고 안쪽에 있다. 입구의 결계부터 어떻게 해야 한다.",
          txt: "먼지 쌓인 일지. 나보다 먼저 이 소설에 빙의했던 누군가의 기록이다. 한 장씩 넘겨 읽어 보자.",
          pages: { sheets: [
        ...
        { id: "chest", nm: "성좌 금고", spr: "chest",
          ...
          lock: { ans: ["482"], digits: 3,
            hints: ["지하 서고의 일지 — 세 번의 죽음마다 숫자가 하나씩 있었어요. 하나는 일지에 없고 연회장 누군가의 입에서 나왔어요.", "1회차 넉 잔째(4), 2회차 초상 복도(바토르가 여덟 점이랬죠, 8), 3회차 새벽 두 시(2). 죽은 순서대로.", "4, 8, 2. 482."],
            open: "궤 안에 은시계 하나. 바늘이 밤 열두 시에 멎어 있다. 이 시계… 목차 7장에서 본 것 같은데.",
            give: "watch" } },
        { id: "butler", nm: "집사 노얀", spr: "butler",
          txt: "노얀이 온화하게 웃으며 다가온다. 어디서 읽은 장면인데. 이 자를 흔들려면 증거가 될 물건을 들이밀어야 한다.",
          speech: [
        ...
        { id: "gate", nm: "완결의 문", spr: "endgate", final: true,
          need: "exposed", lockedTxt: "문이 미동도 없다. 이야기는 범인을 지목해야 끝나는 법이지. 흑막의 정체부터 밝혀내 보자.",
          ...
          lock: { ans: ["노얀"], digits: 2,
            hints: ["연회장의 세 사람을 다시 떠올려 봐요. 하나가 유독 달랐어요.", "연회장의 세 사람 중 상태창이 뜨지 않은 유일한 인물, 멎은 은시계의 주인.", "집사의 이름. '노얀'이에요."],
...
ER_SCENARIOS.push({
  id: "loopstation", title: "루프 정거장 SIGMA", emoji: "🛰️",
  diff: { n: 4, label: "어려움", note: "타임라인 추리 — 온도에 속지 말 것" },
  tagline: "42분마다 되감기는 정거장, 루프를 기억하는 단 한 사람",
  outro: "레버가 내려간 뒤로 정거장은 조용했다. 42분이 지나고, 또 42분이 지나도 아무것도 되감기지 않았다. 냉동수면에서 홀로 깬 밤, 당신이 붙든 단 하나의 기억이 끝없이 되감기던 밤을 끝냈다. 구조선 불빛이 관측창에 닿을 때, 당신은 처음으로 시계가 앞으로 가는 걸 지켜봤다.",
  acts: [
    {
      id: "diagnose",
      name: "제1막 · 42분의 기록",
      intro: "심우주 관측 정거장 SIGMA. 노후한 리액터가 42분마다 과열돼 폭발하고, 그때마다 비상 시간역행 프로토콜이 정거장을 통째로 되감는다.\n\n방금 냉동수면에서 깬 당신만 이상하게도 이 리셋을 비껴갔다. 다른 승무원은 매 루프 기억이 지워진 채 헤매고, 이 밤을 통째로 기억하는 건 당신뿐이다.\n\n이번 42분 안에 폭주의 진원을 찾아 잠가야 한다. 무엇이든 눌러 조사하라.",
      time: 900,
      hearts: 5,
      items: {},
      combos: [],
      objects: [
        { id: "cryopod", nm: "냉동수면 캡슐", spr: "cryopod",
          txt: "당신이 깨어난 캡슐. 성에 낀 유리 안쪽, 계기가 42:00에서 거꾸로 흐른다. 다른 다섯 캡슐은 비었다.\n\n정비 사물함부터 열어라 — 승무원은 로그 판독 모듈을 늘 거기 넣어 둔다." },
        { id: "plaque", nm: "각인 명판", spr: "plaque",
          txt: "출입구 옆 금속 명판.\n\nSIGMA 심우주 관측 정거장\n가동 개시 · 서기 2187년\n관측 대상 · 성간운 표류물" },
        { id: "locker", nm: "정비 사물함", spr: "toolbox",
          txt: "숫자 자물쇠가 걸린 정비 사물함. 승무원은 로그 판독 모듈을 여기 넣어 둔다.",
          lock: { ans: ["2187"], digits: 4,
            hints: ["사물함은 늘 같은 숫자로 잠가 둬요 — 정거장이 처음 돌아간 그 해요.", "벽 명판에 가동 연도가 적혀 있어요. 네 자리예요.", "2187."],
            open: "사물함이 열렸다. 로그 판독 모듈과 격리 패널 인증키. 이제 손상된 기록을 읽을 수 있다.",
            sets: "logs" } },
        { id: "crewlog", nm: "승무원 일지", spr: "journal",
          need: "logs", lockedTxt: "판독 모듈이 없으면 손상된 일지가 읽히지 않는다. 사물함부터 열어라.",
          txt: "복원된 승무원 일지. 한 장씩 넘겨 읽어라.",
          /* 규칙 지급(트릭사전 0-3): '먼저 튄 순서로 잠근다'는 방법만 주고 답은 안 준다. 온도=앵커링 함정을 경고 */
          pages: { sheets: [
            "승무원 일지 · 판독 복원본",
            "또 되감겼다. 눈을 뜨면 늘 42:00. 우리 중 누구도 왜인지 못 찾는다 — 눈뜰 때마다 기억이 지워지니까.",
            "확실한 건 하나. 냉각 밸브가 차례로 과열되며 폭주가 시작된다. 진원부터 순서대로 잠그면 루프를 끊을 실마리가 잡힌다.",
            "격리 순서 = '먼저 튄' 순서다. 가장 뜨거운 밸브가 아니라, 가장 이른 시각에 튄 밸브부터 차례로. 온도에 속지 마라." ] } },
        { id: "terminal", nm: "블랙박스 단말", spr: "glitchwin",
          need: "logs", lockedTxt: "판독 모듈이 없으면 로그가 깨져 보인다. 사물함부터 열어라.",
          txt: "폭주 직전 기록이 순서 없이 떠 있는 단말. 한 장씩 넘겨 보라.",
          pages: { sheets: [
            "블랙박스 · 폭주 직전 기록 (순서 뒤섞임)",
            "▸ 04:09   냉각 밸브 1   ·   96°C   경보",
            "▸ 04:14   냉각 밸브 2   ·   210°C   임계",
            "▸ 04:02   냉각 밸브 3   ·   71°C   경보",
            "▸ 04:04   냉각 밸브 4   ·   78°C   경보" ] } },
        { id: "valves", nm: "격리 밸브 패널", spr: "valvepanel", final: true,
          need: "logs", lockedTxt: "인증키가 없으면 밸브 패널이 열리지 않는다.",
          txt: "냉각 밸브 격리 패널. 밸브 1·2·3·4를 잠글 순서대로 눌러 넣는 자리다.",
          lock: { ans: ["3412"], digits: 4, prompt: "밸브를 잠글 순서를 눌러라. (4자리)",
            hints: ["밸브 잠금엔 순서가 있어요. 로그를 다시 보면 밸브마다 시각이 붙어 있어요.", "제일 뜨거운 밸브가 진원이 아니에요 — 제일 이른 시각(04:02)에 튄 밸브부터 차례로. 그게 폭주가 번진 순서예요.", "시각 순서로 3번(04:02) → 4번(04:04) → 1번(04:09) → 2번(04:14). 3412예요."],
            open: "밸브를 순서대로 잠그자 리액터 경보가 잦아든다. 진원이 봉인됐다 — 하지만 42분이 다 됐다. 화면이 하얗게 되감긴다." } }
      ]
    },
    {
      id: "breakloop",
      name: "제2막 · 루프를 끊다",
      intro: "42:00을 세던 화면이 하얗게 부서지고, 다시 눈을 떴다. 또 그 밤이다.\n\n하지만 이번엔 다르다. 지난 루프에 냉각 밸브를 순서대로 잠근 덕에 진원 구역이 터지지 않았고, 늘 시뻘겋게 막혀 있던 코어 통로가 열려 있다.\n\n루프를 늦추는 걸론 부족하다. 되감기 그 자체를 끊어야 한다. 캄캄한 코어로 들어가라.",
      time: 900,
      hearts: 5,
      items: { cutter: "절연 절단기" },
      combos: [],
      objects: [
        { id: "passage", nm: "코어 통로", spr: "barrier",
          txt: "지난 루프의 격리 덕에 냉각 구역이 잠잠하다. 늘 막혀 있던 코어 통로가 열렸다.\n\n안쪽은 완전한 어둠 — 정전이다. 손전등으로 더듬어 들어가야 한다." },
        { id: "vela", nm: "관제 인격 VELA", spr: "glitchwin",
          txt: "코어 콘솔에 떠오른 관제 인격. 초상을 눌러 말을 붙여 보라.",
          speech: [ { nm: "VELA", spr: "glitchwin", lines: [
            "…깨어났군요, 유일한 사람. 정상 종료 절차를 안내할게요.",
            "코어 콘솔에 종료 코드를 넣으면 이 긴 밤이 끝나요. 다들 그렇게 편해졌어요. 어서요.",
            "…또 되감기면 그만이에요. 당신은 늘 여기서 코드를 넣고, 나는 늘 당신을 다시 재웠죠. 이번에도, 잘 부탁해요." ] } ] },
        { id: "reactor", nm: "리액터 코어", spr: "reactor",
          txt: "정전된 코어. 어둠 속에 계기 세 개가 희미하게 살아 있다. 손전등으로 훑어보라.",
          torch: { prompt: "정전된 코어를 손전등으로 훑어보라.",
            marks: [ { d: "5", x: 24, y: 34 }, { d: "0", x: 52, y: 60 }, { d: "9", x: 78, y: 36 } ] } },
        { id: "cabinet", nm: "코어 공구함", spr: "cabinet",
          txt: "다이얼 자물쇠가 걸린 공구함. 코어에서 읽은 세 자리를 맞춰야 열린다.",
          lock: { ans: ["509"], type: "dial", digits: 3, prompt: "코어에서 읽은 세 자리를 맞춰라.",
            hints: ["코어 어둠 속 계기 세 개를 손전등으로 다 찾았어요? 바늘이 숫자를 가리켜요.", "세 계기의 숫자를 왼쪽부터 차례로 맞춰요.", "5, 0, 9. 509예요."],
            open: "공구함이 열렸다. 절연 절단기 한 자루 — 고압 배선도 끊는 물건이다.",
            give: "cutter" } },
        { id: "codepanel", nm: "종료 코드 콘솔", spr: "bigdial",
          txt: "VELA가 부르는 '종료 코드'를 넣는 코어 콘솔. 입력 슬롯 옆, 지난 루프의 누군가가 손톱으로 긁어 놓은 글자가 있다.\n\n'코드는 넣지 마. 우린 수백 번 넣었고, 그때마다 처음으로 돌아왔어. 되감기는 여기서 안 끝나 — 천장을 봐.'" },
        { id: "lever", nm: "시간역행 레버", spr: "rewindlev", final: true,
          txt: "천장에서 내려온 굵은 레버. '시간역행 프로토콜'이라 새겨져 있고, 봉인선이 칭칭 감겨 있다. 코드로는 못 끊는다 — 이건 손으로 끊어야 한다.",
          lock: { item: "cutter",
            open: "절연 절단기로 봉인선을 끊고, 온 힘으로 레버를 내렸다. 42:00을 향해 달리던 숫자가 처음으로 멈췄다. 되감기는 없다." } }
      ]
    }
  ]
});
...
ER_SCENARIOS.push({
  id: "abyss6000", title: "심연 6000", emoji: "🌊",
  diff: { n: 4, label: "어려움", note: "보이는 위협에 속지 말 것" },
  tagline: "6000m 해저에 좌초된 잠수정, 숨진 선배, 그리고 보이지 않는 죽음",
  outro: "밸러스트를 버리자 잠수정이 천천히 떠오르기 시작했다. 검은 물이 푸르러지고, 마침내 은빛 수면이 머리 위에서 부서졌다. 산소가 아니라 눈에 보이지 않던 것이 선배를 데려갔다는 걸, 당신은 끝내 잊지 않기로 했다.",
  acts: [
    {
      id: "blackout",
      name: "제1막 · 정전",
      intro: "수심 6,000m 열수구 조사 유인잠수정 나르길. 모선과의 연결이 끊기고 해저 경사면에 15도 기울어 좌초했다. 조종석엔 이미 숨진 선배 파일럿.\n\n전력과 산소는 한정돼 있고, 구조가 올 때까지 버텨야 한다. 정전이라 손전등 하나뿐 — 무엇이든 눌러 조사하라.",
      time: 900,
      hearts: 5,
      items: { fuse: "예비 퓨즈" },
      combos: [],
      objects: [
        { id: "pilot", nm: "선배 파일럿", spr: "portrait",
          txt: "조종석에 축 늘어진 선배. 무언가를 꼭 쥐고 있지만, 사후경직으로 손이 펴지지 않는다.\n\n계기판을 보니 산소 잔량은 넉넉하다. 그런데 왜 숨을 거뒀을까." },
        { id: "floor", nm: "기운 바닥", spr: "rug",
          txt: "15도 기운 바닥. 낮은 쪽 구석에 뭔가 굴러가 있다. 손전등으로 비추니 정전 때 빠져 굴러간 예비 퓨즈다. 주웠다.",
          give: "fuse" },
        { id: "breaker", nm: "차단기 패널", spr: "fusebox",
          txt: "퓨즈 하나가 빠져 회로가 죽어 있는 차단기 패널.",
          lock: { item: "fuse",
            open: "빠진 자리에 예비 퓨즈를 꽂자 배전반에 불이 들어오고, 순환팬이 돌기 시작한다. 계기판이 깨어난다.",
            sets: "power" } },
        { id: "logbook", nm: "잠항 일지", spr: "diary",
          txt: "선배의 잠항 일지. 한 장씩 넘겨 읽어라.",
          /* 규칙 지급 + 숨은전제 씨앗(산소 가득한데 두통·나른함 = CO2 중독 증상, CO2를 말하진 않음) */
          pages: { sheets: [
            "파일럿 잠항 일지 — 나르길",
            "열수구 관측은 순조. 다만 스크러버 경보가 자꾸 뜬다. 계기 오작동이겠지 — 산소는 늘 가득이니까.",
            "머리가 좀 아프다. 나른하고 판단이 굼뜨다. 산소계는 92%… 이상 없는데 왜 이러지.",
            "메모: 후방 격벽 비상 코드는 계기반에서 '붉게 경보 뜬 계기'만 왼쪽부터 값을 이어 읽어라. 멀쩡한 계기는 덫이다." ] } },
        { id: "gauges", nm: "계기반", spr: "gauge",
          need: "power", lockedTxt: "정전이라 계기가 다 죽어 있다. 전력부터 살려라.",
          txt: "되살아난 계기반. 계기를 눌러 값을 확인하라 — 붉게 경보 뜬 것과 멀쩡한 것이 섞여 있다.",
          /* 심볼 필터(트릭사전 2장): 붉은 경보 계기(gaugered)만 골라 왼쪽부터 = 371. 정상 계기는 노이즈(산소 92=숨은전제 씨앗) */
          find: { cols: 4, prompt: "계기를 눌러 확인하라.",
            cells: [ { s: "gauge", c: "6000" }, { s: "gaugered", c: "3" }, { s: "gauge", c: "92" }, { s: "gaugered", c: "7" },
                     { s: "gauge", c: "4" }, { s: "gauge", c: "12" }, { s: "gaugered", c: "1" }, { s: "gauge", c: "88" } ] } },
        { id: "hatch", nm: "후방 격벽", spr: "endgate", final: true,
          need: "power", lockedTxt: "정전이라 격벽 키패드가 죽어 있다. 전력부터 살려라.",
          txt: "후방 기관실로 통하는 격벽. 비상 코드 키패드가 붙어 있다.",
          lock: { ans: ["371"], digits: 3, prompt: "후방 격벽 코드 (3자리)",
            hints: ["계기반을 다시 봐요 — 전부가 단서는 아니에요. 경보 뜬 계기와 멀쩡한 계기를 구분해 봐요.", "붉게 경보 뜬 계기만, 왼쪽부터 값을 이어 읽어요. 정상 계기(수심·산소 같은)는 무시.", "붉은 계기 셋은 3, 7, 1. 371이에요."],
            open: "코드를 넣자 격벽이 무겁게 열린다. 좁은 기관실 안쪽 — 여기서 구조를 기다리면 된다." } }
      ]
    },
    {
      id: "invisible",
      name: "제2막 · 보이지 않는 죽음",
      intro: "격벽 너머 좁은 기관실. 여기서 버티면 된다고 믿었다.\n\n그런데 몸이 자꾸 무겁다. 판단이 흐려진다. 선배도 이랬을까. 산소계는 여전히 가득한데.\n\n선배가 마지막까지 쥐고 있던 게 뭔지, 이제 봐야 한다.",
      time: 900,
      hearts: 5,
      items: { cartridge: "예비 스크러버 카트리지" },
      combos: [],
      objects: [
        { id: "o2valve", nm: "산소 공급 밸브", spr: "gauge",
          txt: "산소 공급 밸브. 옆 계기는 이미 92%로 가득 차 있다. 더 열 데가 없다.\n\n숨은 계속 가쁜데 산소는 넘친다 — 그럼 대체 뭐가 문제일까." },
        { id: "pilothand", nm: "선배가 쥔 것", spr: "portrait",
          txt: "이제야 선배의 굳은 손을 조심스레 폈다. 손안에 든 건 새까맣게 포화된 CO₂ 스크러버 카트리지. 마지막 순간까지 이걸 갈아 끼우려 했다.\n\n산소가 아니었다. 우리를 죽인 건 우리가 내뱉은 이산화탄소였다.",
          sets: "truth" },
        { id: "maintcard", nm: "정비 도표", spr: "diary",
          txt: "생명유지계 정비 도표. 한 장씩 넘겨 보라.",
          pages: { sheets: [
            "정비 도표 · 나르길 생명유지계",
            "CO₂ 스크러버 — 잠수정 공기에서 이산화탄소를 걷어낸다. 이게 포화되면 산소가 가득해도 사람이 질식한다.",
            "예비 카트리지는 비상 보관함에. 보관함 코드 = 스크러버를 마지막으로 교체한 날짜(월일 네 자리).",
            "교체 이력 —   03·14    ·    01·02    ·    02·28" ] } },
        { id: "storage", nm: "비상 보관함", spr: "toolbox",
          txt: "숫자 자물쇠가 걸린 비상 보관함. 예비 카트리지가 이 안에 있다.",
          lock: { ans: ["0314"], digits: 4,
            hints: ["예비 카트리지는 비상 보관함에 있어요. 코드는 정비 도표가 알려줘요.", "보관함 코드는 스크러버를 마지막으로 교체한 날짜예요 — 교체 이력 중 가장 최근(가장 늦은) 날짜.", "가장 최근 교체일은 03·14. 0314예요."],
            open: "보관함이 열렸다. 새 CO₂ 스크러버 카트리지 하나.",
            give: "cartridge" } },
        { id: "scrubber", nm: "CO₂ 스크러버", spr: "scrubber", final: true,
          need: "truth", lockedTxt: "기관실 구석의 어떤 장치 — 지금은 눈에 안 들어온다. 온통 산소 생각뿐이라.",
          txt: "CO₂ 스크러버 유닛. 카트리지가 새까맣게 포화됐다. 이걸 갈면 탁한 공기가 다시 맑아진다.",
          lock: { item: "cartridge",
            open: "포화된 카트리지를 뽑고 새것을 끼웠다. 탁한 공기가 서서히 맑아지고, 무겁던 머리가 갠다. 맑은 정신으로 밸러스트를 버리자 잠수정이 떠오르기 시작한다." } }
      ]
    }
  ]
});
...
function erRenderInv(){
  ...
  if (!items.length){ inv.innerHTML = '<span class="er-inv-empty">🎒 인벤토리 — 아직 비었어요</span>'; return; }
...
function erDialHtml(o){
  ...
  return '<div class="hint" style="margin-top:8px">' + escHtml(o.lock.prompt || "다이얼을 돌려 맞춰 봐요.") + "</div>" +
  ...
  if (!solved && !gated && o.lock){
    if (o.lock.ans && o.lock.type === "dial"){
      ...
      html += has
        ...
        : '<div class="hint">아직 필요한 게 없어요 — 뭔가를 얻거나 조합해야 해요. (필요: ' + escHtml(nm) + ")</div>";
    }
  }
...
function erHint(){
  ...
  if (step >= o.lock.hints.length){ $("er-hintout").textContent = "💡 이 자물쇠 힌트는 여기까지예요."; $("er-hintout").style.display = ""; return; }
...
function erAssembleView(combo){
  ...
  const sc = cfg.scale || 4;   /* 16×16=4(→64px), 32×32 조각=2(→64px) — 표시 크기 통일 */
  const p = $("er-panel");
  p.innerHTML =
    ...
    '<div class="er-asm" id="er-asm">' +
      ...
      '<div class="er-asm-base"><px-sprite name="' + cfg.base + '" scale="' + sc + '"></px-sprite></div>' +
      '<div class="er-asm-piece" id="er-asm-piece" style="--rot:' + rot + 'deg"><px-sprite name="' + cfg.piece + '" scale="' + sc + '"></px-sprite></div>' +
    "</div>" +
...
function erFail(msg){
  ...
  $("er-fail-sub").textContent = "이 막 처음부터 다시 할 수 있어요 (지금까지 연 자물쇠는 초기화돼요).";
}
