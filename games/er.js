...
ER_SCENARIOS.push({
  ...
  outro: "레버가 내려간 뒤로 정거장은 조용했다. 42분이 지나고, 또 42분이 지나도 아무것도 되감기지 않았다. 냉동수면에서 홀로 깬 밤, 네가 붙든 단 하나의 기억이 끝나지 않던 밤을 끝냈다. 구조선의 불빛이 관측창에 닿을 때, 너는 처음으로 시계가 앞으로 가는 걸 지켜봤다.",
  acts: [
    {
      id: "diagnose",
      name: "제1막 · 42분의 기록",
      intro: "심우주 관측 정거장 SIGMA. 노후한 리액터가 42분마다 과열돼 폭발하고, 그때마다 비상 시간역행 프로토콜이 정거장을 통째로 되감는다.\n\n방금 냉동수면에서 깬 너만 리셋에 면역이다 — 다른 승무원은 매 루프 기억이 지워진 채 헤매고, 이 밤을 통째로 기억하는 건 오직 너뿐.\n\n이번 42분 안에 폭주의 진원을 찾아 잠가야 한다. 뭐든 눌러서 조사해 봐요.",
      time: 900,
      hearts: 5,
      items: {},
      combos: [],
      objects: [
        { id: "cryopod", nm: "냉동수면 캡슐", spr: "cryopod",
          txt: "네가 깨어난 캡슐. 성에 낀 유리 안쪽 계기가 42:00에서 거꾸로 흐른다. 다른 다섯 캡슐은 비었다.\n\n정비 사물함부터 열어 봐요 — 승무원들이 로그 판독 모듈을 늘 거기 넣어 두니까." },
        { id: "plaque", nm: "각인 명판", spr: "plaque",
          txt: "출입구 옆 금속 명판.\n\nSIGMA 심우주 관측 정거장\n가동 개시 · 서기 2187년\n관측 대상 · 성간운 표류물" },
        { id: "locker", nm: "정비 사물함", spr: "toolbox",
          txt: "숫자 자물쇠가 걸린 정비 사물함. 승무원들이 로그 판독 모듈을 여기 넣어 둔다.",
        ...
        { id: "crewlog", nm: "승무원 일지", spr: "journal",
          need: "logs", lockedTxt: "판독 모듈이 없으면 손상된 일지가 안 읽혀요. 사물함부터.",
          txt: "복원된 승무원 일지. 한 장씩 넘겨 읽어 봐요.",
          /* 규칙 지급(트릭사전 0-3): '먼저 튄 순서로 잠근다'는 방법만 주고 답은 안 준다. 온도=앵커링 함정을 경고 */
          pages: { sheets: [
            "승무원 일지 · 판독 복원본",
            "또 되감겼다. 눈을 뜨면 늘 42:00. 우리 중 누구도 왜인지 못 찾는다 — 눈뜰 때마다 기억이 지워지니까.",
            "확실한 건 하나. 냉각 밸브들이 차례로 과열되며 폭주가 시작된다. 진원부터 순서대로 잠그면 루프를 끊을 실마리가 잡힌다.",
            "격리 순서 = '먼저 튄' 순서다. 가장 뜨거운 밸브가 아니라, 가장 이른 시각에 튄 밸브부터 차례로. 온도에 속지 마라." ] } },
        { id: "terminal", nm: "블랙박스 단말", spr: "glitchwin",
          need: "logs", lockedTxt: "판독 모듈이 없으면 로그가 깨져 보여요. 사물함부터.",
          txt: "폭주 직전 기록이 순서 없이 떠 있는 단말. 한 장씩 넘겨 봐요.",
          pages: { sheets: [
        ...
        { id: "valves", nm: "격리 밸브 패널", spr: "valvepanel", final: true,
          need: "logs", lockedTxt: "인증키가 없으면 밸브 패널이 안 열려요.",
          txt: "냉각 밸브 격리 패널. 밸브 1·2·3·4를, 잠글 순서대로 눌러 넣는 자리다.",
          lock: { ans: ["3412"], digits: 4, prompt: "밸브를 잠글 순서를 눌러요. (4자리)",
    ...
    },
    {
      id: "breakloop",
      name: "제2막 · 루프를 끊다",
      intro: "42:00을 세던 화면이 하얗게 부서지고, 다시 눈을 떴다. 또 그 밤이다.\n\n하지만 이번엔 다르다. 지난 루프에 냉각 밸브를 순서대로 잠근 덕에 진원 구역이 안 터졌고, 늘 시뻘겋게 막혀 있던 코어 통로가 열려 있다.\n\n루프를 늦추는 걸론 부족해. 되감기 그 자체를 끊어야 한다. 캄캄한 코어로 들어가요.",
      time: 900,
      hearts: 5,
      items: { cutter: "절연 절단기" },
      combos: [],
      objects: [
        ...
        { id: "vela", nm: "관제 인격 VELA", spr: "glitchwin",
          txt: "코어 콘솔에 떠오른 관제 인격. 초상을 눌러 말을 붙여 봐요.",
        ...
        { id: "reactor", nm: "리액터 코어", spr: "reactor",
          txt: "정전된 코어. 어둠 속에 계기 세 개가 희미하게 살아 있다. 손전등으로 훑어 봐요.",
          torch: { prompt: "정전된 코어를 손전등으로 훑어 봐요.",
            marks: [ { d: "5", x: 24, y: 34 }, { d: "0", x: 52, y: 60 }, { d: "9", x: 78, y: 36 } ] } },
        { id: "cabinet", nm: "코어 공구함", spr: "cabinet",
          txt: "다이얼 자물쇠가 걸린 공구함. 코어에서 읽은 세 자리를 맞춰야 열린다.",
          lock: { ans: ["509"], type: "dial", digits: 3, prompt: "코어에서 읽은 세 자리를 맞춰요.",
...
ER_SCENARIOS.push({
  ...
  outro: "밸러스트를 버리자 잠수정이 천천히 떠오르기 시작했다. 검은 물이 푸르러지고, 마침내 은빛 수면이 머리 위에서 부서졌다. 산소가 아니라 눈에 안 보이던 것이 선배를 데려갔다는 걸, 너는 끝내 잊지 않기로 했다.",
  acts: [
    {
      id: "blackout",
      name: "제1막 · 정전",
      intro: "수심 6,000m 열수구 조사 유인잠수정 나르길. 모선과의 연결이 끊기고 해저 경사면에 15도 기울어 좌초했다. 조종석엔 이미 숨진 선배 파일럿.\n\n전력과 산소는 한정돼 있고, 구조가 올 때까지 버텨야 한다. 정전이라 손전등 하나뿐 — 뭐든 눌러서 조사해 봐요.",
      time: 900,
      hearts: 5,
      items: { fuse: "예비 퓨즈" },
      combos: [],
      objects: [
        ...
        { id: "gauges", nm: "계기반", spr: "gauge",
          need: "power", lockedTxt: "정전이라 계기가 다 죽어 있어요. 전력부터 살려요.",
          txt: "되살아난 계기반. 계기를 눌러 값을 확인해 봐요 — 붉게 경보 뜬 것과 멀쩡한 것이 섞여 있다.",
          /* 심볼 필터(트릭사전 2장): 붉은 경보 계기(gaugered)만 골라 왼쪽부터 = 371. 정상 계기는 노이즈(산소 92=숨은전제 씨앗) */
          find: { cols: 4, prompt: "계기를 눌러 확인해 봐요.",
        ...
        { id: "hatch", nm: "후방 격벽", spr: "endgate", final: true,
          need: "power", lockedTxt: "정전이라 격벽 키패드가 죽어 있어요. 전력부터.",
    ...
    },
    {
      ...
      objects: [
        ...
        { id: "pilothand", nm: "선배가 쥔 것", spr: "portrait",
          txt: "이제야 선배의 굳은 손을 조심스레 폈다. 손안에 든 건 새까맣게 포화된 CO₂ 스크러버 카트리지. 마지막 순간까지 이걸 갈아 끼우려 했던 거다.\n\n산소가 아니었다. 우리를 죽이고 있는 건, 우리가 내뱉은 이산화탄소였다.",
          sets: "truth" },
        { id: "maintcard", nm: "정비 도표", spr: "diary",
          txt: "생명유지계 정비 도표. 한 장씩 넘겨 봐요.",
          pages: { sheets: [
            "정비 도표 · 나르길 생명유지계",
