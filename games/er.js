      ...
      objects: [
        ...
        { id: "maintcard", nm: "정비 도표", spr: "diary",
          ...
          pages: { sheets: [
            ...
            "교체 이력 —   01·02    ·    02·28    ·    03·14 (최종)" ] } },
        { id: "storage", nm: "비상 보관함", spr: "toolbox",
          txt: "숫자 자물쇠가 걸린 비상 보관함. 예비 카트리지가 이 안에 있다.",
          lock: { ans: ["0314"], digits: 4,
            hints: ["예비 카트리지는 비상 보관함에 있어요. 코드는 정비 도표가 알려줘요.", "보관함 코드는 스크러버를 마지막으로 교체한 날짜예요. 도표의 교체 이력 맨 끝.", "최종 교체일 03·14. 0314예요."],
